...
//	OtherSound(16)=Male1Voice.M1ObjectDestroy
    ...
    MirrorSounds(1)=sound'a_dukevoice.mirror.DukeMirror2'
    MirrorSounds(2)=sound'a_dukevoice.mirror.DukeMirror3'
    MirrorSounds(3)=sound'a_dukevoice.mirror.DukeMirror4'
    MirrorSounds(4)=sound'a_dukevoice.mirror.DukeMirror5'
	numMirrorSounds=5;

    PickupSounds(0)=sound'a_dukevoice.DukeLines.DGroovy'
    PickupSounds(1)=sound'a_dukevoice.DukeLines.DBuyDollar'
    PickupSounds(2)=sound'a_dukevoice.DukeLines.DChristmas'
    PickupSounds(3)=sound'a_dukevoice.DukeLines.DConvenient'
    PickupSounds(4)=sound'a_dukevoice.DukeLines.DFreshHard'
    PickupSounds(5)=sound'a_dukevoice.DukeLines.DBringPain'
    PickupSounds(6)=sound'a_dukevoice.DukeLines.DLikeIt'
    PickupSounds(7)=sound'a_dukevoice.DukeLines.DMoreEq'
    PickupSounds(8)=sound'a_dukevoice.DukeLines.DNinjaThis'
	numPickupSounds=9;

	/*
	DeathSounds(0)=sound'a_dukevoice.mirror.DukeMirror4'
	DeathSounds(1)=sound'a_dukevoice.mirror.DukeMirror4'
	DeathSounds(2)=sound'a_dukevoice.mirror.DukeMirror4'
	DeathSounds(3)=sound'a_dukevoice.mirror.DukeMirror4'
	DeathSounds(4)=sound'a_dukevoice.mirror.DukeMirror4'
	DeathSounds(5)=sound'a_dukevoice.mirror.DukeMirror4'
	numDeathSounds=6;
	*/

	DeathSounds(0)=sound'a_dukevoice.Pain.DukePainDeath1'
	DeathSounds(1)=sound'a_dukevoice.Pain.DukePainDeath2'
	numDeathSounds=2;
