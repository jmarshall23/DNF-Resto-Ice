...
function Used( Actor Other, Pawn EventInstigator )
{
	...
	// FairFriend: Can't use touchscreen if carrying an object
	if ( Other.IsA('DukePlayer') && !(DukePlayer(Other).CarriedDecoration == None ))
		return;
...
function ScreenTouched( Pawn Other, float X, float Y )
{
	...
	// FairFriend: Can't touch touchscreen if carrying an object
	if ( Other.IsA('DukePlayer') && !(DukePlayer(Other).CarriedDecoration == None ))
		return;
...
function Examine( Actor Other )
{
	...
	// FairFriend: Can't examine touchscreen if carrying an object
	if ( Other.IsA('DukePlayer') && !(DukePlayer(Other).CarriedDecoration == None ))
		return;
