...
function Tick(float DeltaSeconds)
{
	...
	// explanation because i was confused:
	// the name LastDeltaSeconds is a little confusing,
	// as it makes you assume it's the deltaseconds from the last frame
	// but it's not, all it's doing is storing Tick's DeltaSeconds argument
	// into a global variable to use across the entire file
	// -x ;3

	// Remember this delta
	LastDeltaSeconds = DeltaSeconds;

	// this caused motorcycle to go wack, no clue why they did this. -x
	/*
