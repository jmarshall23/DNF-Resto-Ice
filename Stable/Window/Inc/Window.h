...
class WINDOW_API WPasswordDialog : public WDialog
{
	...
	, OkButton    ( this, IDOK,     FDelegate(this,(TDelegate)&WPasswordDialog::EndDialogTrue) )
	, CancelButton( this, IDCANCEL, FDelegate(this,(TDelegate)&WPasswordDialog::EndDialogFalse) )
...
class WINDOW_API WTextScrollerDialog : public WDialog
{
	...
	, OkButton  ( this, IDOK, FDelegate(this,(TDelegate)&WTextScrollerDialog::EndDialogTrue) )
	, Caption   ( InCaption )
	, Message   ( InMessage )
	{}
...
public:
	...
	void OnItemSetFocus()
	{
		...
		&&	!(Property->PropertyFlags & CPF_EditConst) )
		{
			...
			*/
			AddButton( TEXT(" ? "), FDelegate(this,(TDelegate)&FPropertyItem::OnHelpButton), true );
			// ...CDH
