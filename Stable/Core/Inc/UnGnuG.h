...
//
// TODO: Replace __rdtsc with clock_gettime. This function will also
// require testing on a Linux GCC compiler.
...
inline DWORD appCycles()
{
	if( GTimestamp )
	{
		...
		return r;
#else
		return (__int64)__builtin_ia32_rdtsc();
#endif
	}
}
...
#else
		__int64 tsc = __builtin_ia32_rdtsc();
		return tsc * GSecondsPerCycle;
#endif
	}
