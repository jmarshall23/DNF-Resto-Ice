...
defaultproperties
{
     ...
     MountOnSpawn(2)=(ActorClass=Class'dnParticles.dnDroneJet_WingLight1',SetMountOrigin=True,MountOrigin=(X=120.000000,Y=50.000000,Z=-52.000000))
     MountOnSpawn(3)=(ActorClass=Class'dnParticles.dnDroneJet_WingLight1',SetMountOrigin=True,MountOrigin=(X=120.000000,Y=-50.000000,Z=-52.000000))
