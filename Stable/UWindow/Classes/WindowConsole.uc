...
function CloseUWindow()
{
	...
	// FairFriend: When closing the desktop make a call to 
	// its own implementation of HideWindow() to also hide
	// all the sub-icons 
	if ( Root.ActiveWindow.IsA('UDukeDesktopWindow') )
		Root.ActiveWindow.HideWindow();
}
...
function CreateRootWindow(Canvas Canvas)
{
	...
	ConsoleWindow.bMessageBoxFrame = true;	// FairFriend: The console should have no buttons.
	HideConsole( true );
