...
var bool					bExitButtonOnly;	// FairFriend: The frame doesn't have the reset button.
...
function LMouseDown(float X, float Y)
{
	...
	Super.LMouseDown(X, Y);
        ...
        if (H == HT_None) // HT_TitleBar doesnt work
	{
		MoveX = X;
		MoveY = Y;
		bMoving = True;
...
defaultproperties
{
	 ...
	 bExitButtonOnly=true;	// FairFriend: By default window frames have no reset button.
}
