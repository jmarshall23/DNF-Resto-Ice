...
class DLL_EXPORT USoftwareRenderDevice : public URenderDevice
{
	...
	void __fastcall DrawGouraudPolygon( FSceneNode* Frame, FTextureInfo& Texture, FTransTexture** Pts, INT NumPts, DWORD PolyFlags, FSpanBuffer* SpanBuffer, DWORD PolyFlagsEx );
