...
#undef RGBA_MAKE
	...
	void __fastcall SetSceneNode(FSceneNode* Frame);
	...
	void __fastcall DrawTile(FSceneNode* Frame, FTextureInfo& Info, FLOAT X, FLOAT Y, FLOAT XL, FLOAT YL, FLOAT U, FLOAT V, FLOAT UL, FLOAT VL, class FSpanBuffer* Span, FLOAT Z, FPlane Color, FPlane Fog, DWORD PolyFlags, DWORD PolyFlagsEx, FLOAT alpha, FLOAT rot, FLOAT rotationOffsetX, FLOAT rotationOffsetY );
	...
	void __fastcall ReadPixels(FColor* Pixels, UBOOL BackBuffer);
