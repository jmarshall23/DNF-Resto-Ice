...
AUTOGENERATE_NAME(FocalPointNotVisible)
...
AUTOGENERATE_NAME(ProcessChangeClass)
...
AUTOGENERATE_NAME(GetModeAmmoEvent)
...
enum ERenderStyle
{
    ...
    STY_Modulated           =4,
    STY_Translucent2        =5,
    STY_LightenModulate     =6,
    STY_DarkenModulate      =7,
    STY_MAX                 =8,
};
enum EDrawType
{
...
struct AActor_eventEnumSurfsInRadiusCB_Parms
{
    INT SurfIndex;
    class UTexture* SurfTex;
    FVector HitLocation;
    FVector SurfNormal;
};
...
struct AActor_eventStoppedRolling_Parms
{
};
...
{
public:
    class AActor* CarriedDecoration;
    ...
    BITFIELD bDebugEventsVerbose:1;
    ...
    FVector TravelLocation GCC_PACK(4);
    FRotator TravelRotation;
    INT DiscardedPhysicsFrames;
    ...
    INT TimerLoop[6];
    TArray<FLOAT> CallbackTimerRates;
    TArray<FLOAT> CallbackTimerCounters;
    TArray<INT> CallbackTimerLoops;
    TArray<INT> CallbackTimerPointers;
    INT MaxTimers;
    FLOAT LifeSpan;
    ...
    class UMeshInstance* LastMeshInstance;
    INT DX8MeshHandle;
    FLOAT LastRenderTime;
    BITFIELD bShadowCast:1 GCC_PACK(4);
    BITFIELD bShadowReceive:1;
    BITFIELD bUnlit:1;
    ...
    DECLARE_FUNCTION(execEnumSurfsInRadius);
    ...
    inline void __fastcall eventEnumSurfsInRadiusCB(INT SurfIndex, class UTexture* SurfTex, FVector HitLocation, FVector SurfNormal)
    {
        AActor_eventEnumSurfsInRadiusCB_Parms Parms;
        Parms.SurfIndex=SurfIndex;
        Parms.SurfTex=SurfTex;
        Parms.HitLocation=HitLocation;
        Parms.SurfNormal=SurfNormal;
        ProcessEvent(FindFunctionChecked(ENGINE_EnumSurfsInRadiusCB),&Parms);
    }
    ...
    inline void __fastcall eventStoppedRolling()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_StoppedRolling),NULL);
    }
...
public:
    ...
    FLOAT ScrollSpeed;
    DECLARE_CLASS(AMapLocations,AInfo,0|CLASS_Transient|CLASS_Config)
    NO_DEFAULT_CONSTRUCTOR(AMapLocations)
};


class ENGINE_API ADOTAffector : public AInfo
{
public:
    class ADOTAffector* NextAffector;
    INT Type;
    FLOAT Damage;
    FLOAT Time;
    FLOAT Counter;
    ...
    BITFIELD bNoTimeoutWhileTouching:1 GCC_PACK(4);
    class AActor* TouchingActor GCC_PACK(4);
    class APawn* AffectedPawn;
    class APawn* DOTInstigator;
    DECLARE_CLASS(ADOTAffector,AInfo,0)
    NO_DEFAULT_CONSTRUCTOR(ADOTAffector)
};


class ENGINE_API AActorDamageEffect : public AInfo
{
public:
    DECLARE_CLASS(AActorDamageEffect,AInfo,0)
    NO_DEFAULT_CONSTRUCTOR(AActorDamageEffect)
};
...
public:
    ...
    BITFIELD bSquelch:1 GCC_PACK(4);
...
public:
    ...
    DECLARE_CLASS(ALevelInfo,AZoneInfo,0|CLASS_Config)
...
public:
    ...
    FLOAT FallingDamageScale GCC_PACK(4);
    BITFIELD bPlayStinger:1 GCC_PACK(4);
    ...
    class UClass* GameReplicationInfoClass GCC_PACK(4);
...
public:
    ...
    BITFIELD TriggerSurfEventOnHit:1;
    BITFIELD TriggerSurfEventOnce:1;
    FVector AppliedForce GCC_PACK(4);
    BITFIELD bBurrowableStone:1 GCC_PACK(4);
    BITFIELD bBurrowableDirt:1;
    class UMesh* BurrowMesh GCC_PACK(4);
    class UClass* BurrowParticlesUp;
    class UClass* BurrowParticlesDown;
    DECLARE_CLASS(AMaterial,AInfoActor,0)
    NO_DEFAULT_CONSTRUCTOR(AMaterial)
};


class ENGINE_API AFocalPoint : public AInfoActor
{
public:
    FLOAT NotifyFrequency;
    FLOAT PeripheryMod;
    BITFIELD bSleepUntilTriggered:1 GCC_PACK(4);
    BITFIELD bOn:1;
    DECLARE_FUNCTION(execNotifyObservers);
    DECLARE_CLASS(AFocalPoint,AInfoActor,0)
    #include "AFocalPoint.h"
};
...
{
public:
    BITFIELD bAffectWorld:1 GCC_PACK(4);
    FLOAT ProjectorNear GCC_PACK(4);
    FLOAT ProjectorFar;
    FLOAT ProjectorFadeScale;
...
public:
    ...
    FLOAT poundTime;
    BITFIELD bTurnOffOnSurfTrigger:1 GCC_PACK(4);
    FLOAT ShadowBrightnessCuttoff GCC_PACK(4);
    BITFIELD bOldActorShadows:1 GCC_PACK(4);
...
public:
    ...
    FVector FlashFog;
    FLOAT gibChance;
    BITFIELD bFlyCarcass:1 GCC_PACK(4);
    BITFIELD bShieldBlocks:1;
    BITFIELD bBloodPool:1;
    class UTexture* Icon GCC_PACK(4);
...
public:
    ...
    BITFIELD SmoothTransition:1 GCC_PACK(4);
    FLOAT TeleportRadius GCC_PACK(4);
...
public:
    ...
    BITFIELD bDeletedOwner:1 GCC_PACK(4);
    BITFIELD bExaminable:1;
    ...
    class AActorDamageEffect* ImmolationActor GCC_PACK(4);
    FStringNoInit ImmolationClass;
    BITFIELD bFreezable:1 GCC_PACK(4);
    class AActorDamageEffect* FreezeActor GCC_PACK(4);
    FStringNoInit FreezeClass;
    BITFIELD bShrinkable:1 GCC_PACK(4);
    class AActorDamageEffect* ShrinkActor GCC_PACK(4);
    FStringNoInit ShrinkClass;
...
struct ENGINE_API FFacialNoiseInfo
{
    FName BoneName;
    BYTE Type;
    FLOAT Rate;
    ...
    FLOAT PercentStop;
    FLOAT PercentStart;
    FLOAT PercentSameDir;
    FLOAT Noise;
    INT Dir;
};

struct ENGINE_API FFacialTrackInfo
{
    INT Channel1;
    INT Channel2;
    INT CurIndex;
    ...
    INT Frame2;
    FLOAT CurTrackBlend;
    INT CurTrackBlendDir;
    FLOAT CurFrameDelay;
    FLOAT CurFrameBlend;
    FLOAT CurJawScale;
};

struct ENGINE_API FSFacialExpressionFrame
{
    FName AnimName;
    FLOAT JawScale;
    FLOAT Delay;
...
struct ENGINE_API FSFacialExpression
{
    FSFacialExpressionFrame FacialFrame[16];
    BITFIELD bNoLoop:1 GCC_PACK(4);
};
...
struct APawn_eventFocalPointNotVisible_Parms
{
};
struct APawn_eventSeeFocalPoint_Parms
{
    class AActor* Seen;
};
...
public:
    ...
    FLOAT LastSeenTime;
    FLOAT CombatStyle;
    BITFIELD bPlayerCanSeeMe:1 GCC_PACK(4);
    FLOAT Alertness GCC_PACK(4);
    FName NextState;
    FName NextLabel;
    ...
    BITFIELD bWeaponNoAnimSound:1 GCC_PACK(4);
    ...
    FVector DamageLocation GCC_PACK(4);
    FStringNoInit BloodHitDecalName;
    class UClass* BloodHitDecal;
    FStringNoInit BloodPuffName;
    class UClass* BloodPuff;
    class ADOTAffector* DOTAffectorList;
    BITFIELD bTakesDOT:1 GCC_PACK(4);
    INT ExplosiveArea GCC_PACK(4);
    ...
    BITFIELD bLaissezFaireBlending:1 GCC_PACK(4);
    BITFIELD bBlinked:1;
    ...
    INT PelvisBone;
    INT ChestBone;
    FLOAT AbdomenRotationScale;
    FLOAT PelvisRotationScale;
    FLOAT ChestRotationScale;
    FLOAT BoneScales[6];
    FLOAT AlertTimer;
    BYTE FacialExpression;
    FSFacialExpression FacialExpressions[16];
    FLOAT TargetLipBlendPercent;
    FLOAT TargetLipBlendRate;
    FLOAT LipRampSpeed;
    FLOAT LipScale;
    FLOAT CurSoundLevel;
    FLOAT CurLipBlendPercent;
    FFacialTrackInfo FacialTrack[2];
    BITFIELD bFacialNoise:1 GCC_PACK(4);
    FFacialNoiseInfo FacialNoise[8] GCC_PACK(4);
    ...
    FLOAT ShrinkTime;
    FLOAT ShrinkCounter;
    FLOAT ShrinkCounterDestination;
    FLOAT ShrinkRate;
    FLOAT PreShrinkDrawScale;
    BITFIELD bRestoringShrink:1 GCC_PACK(4);
    BITFIELD bNotShrunkAtAll:1;
    BITFIELD bFullyShrunk:1;
    BITFIELD bPartiallyShrunk:1;
    BITFIELD bPuddleArea:1;
    class UClass* PuddleSplashStepEffect GCC_PACK(4);
    class UClass* SplashStepEffect;
    class UClass* FireStepEffect;
    class UClass* FireStepEffectShrunk;
    BYTE bUse;
    BYTE bZoom;
    BYTE bRun;
    BYTE bLook;
    ...
    BITFIELD bNoLogout:1 GCC_PACK(4);
    ...
    inline void __fastcall eventFocalPointNotVisible()
    {
        if(IsProbing(NAME_FocalPointNotVisible)) {
        ProcessEvent(FindFunctionChecked(ENGINE_FocalPointNotVisible),NULL);
        }
    }
    inline void __fastcall eventSeeFocalPoint(class AActor* Seen)
    {
        APawn_eventSeeFocalPoint_Parms Parms;
        if(IsProbing(NAME_SeeFocalPoint)) {
        Parms.Seen=Seen;
        ProcessEvent(FindFunctionChecked(ENGINE_SeeFocalPoint),&Parms);
        }
    }
...
struct APlayerPawn_eventProcessChangeClass_Parms
{
};
...
struct APlayerPawn_eventTickVibration_Parms
{
    FLOAT DeltaTime;
};
...
public:
    ...
    BITFIELD bNoTracking:1 GCC_PACK(4);
    ...
    BITFIELD bEatInput:1 GCC_PACK(4);
    FLOAT MouseZeroTime GCC_PACK(4);
    INT useZone;
    ...
    FName RotateViewCallback;
    FVector VibrationVector;
    FVector VibrationTarget;
    FLOAT VibrationTime;
    FLOAT VibrationElasticity;
    ...
    BITFIELD bChangeClass:1;
    BITFIELD bQuickChangeClass:1;
    FStringNoInit newPawnClass GCC_PACK(4);
    INT maxHealth;
    BITFIELD bCanPlantBomb:1 GCC_PACK(4);
    BITFIELD bStrafeRoll:1;
    FLOAT WeapFireGrow GCC_PACK(4);
    ...
    FLOAT targetpitch;
    FLOAT targetyaw;
    BITFIELD AutoChargeB:1 GCC_PACK(4);
    DECLARE_FUNCTION(execDoChangeClass);
    ...
    DECLARE_FUNCTION(execSaveLoadActive);
    DECLARE_FUNCTION(execDoClientPossess);
    inline void __fastcall eventProcessChangeClass()
    {
        ProcessEvent(FindFunctionChecked(ENGINE_ProcessChangeClass),NULL);
    }
    ...
    inline void __fastcall eventTickVibration(FLOAT DeltaTime)
    {
        APlayerPawn_eventTickVibration_Parms Parms;
        Parms.DeltaTime=DeltaTime;
        ProcessEvent(FindFunctionChecked(ENGINE_TickVibration),&Parms);
    }
...
public:
    ...
    BITFIELD bTriggerByFriend:1;
    FLOAT AlmostClosedDegrees GCC_PACK(4);
    FLOAT AlmostClosedDist;
...
public:
    ...
    BITFIELD bClientNotifyUnUsed:1;
    BITFIELD bOldShadowReceive:1;
    ...
    FLOAT ScaleGlowRampTime;
    FLOAT OriginalScaleGlow;
    FLOAT TargetScaleGlow;
    FLOAT TimePassed;
    BITFIELD ScaleGlowRampUp:1 GCC_PACK(4);
    FSThirdPersonInfo ThirdPersonInfo GCC_PACK(4);
...
public:
    ...
    BITFIELD bNoTakeOwnerProperties:1;
...
public:
    ...
    INT Charge GCC_PACK(4);
    INT MaxCharge;
    BITFIELD bInvForceRep:1 GCC_PACK(4);
    BITFIELD bCustomPickupSettings:1;
    FName RestSequence GCC_PACK(4);
    FStringNoInit SpawnOnHitClassString;
    BITFIELD bDoRespawnMarker:1 GCC_PACK(4);
    class ARespawnMarker* MyRespawnMarker GCC_PACK(4);
    BITFIELD bCanActivateWhileHandUp:1 GCC_PACK(4);
...
public:
    ...
    BITFIELD bShrunkProjectile:1 GCC_PACK(4);
    class UClass* ProjectileClass GCC_PACK(4);
    class UClass* ShrunkProjectileClass;
    BITFIELD bShrunkAltProjectile:1 GCC_PACK(4);
    class UClass* AltProjectileClass GCC_PACK(4);
    class UClass* ShrunkAltProjectileClass;
    FLOAT ProjectileSpeed;
    FLOAT AltProjectileSpeed;
    FRotator AdjustedAim;
    BITFIELD bCanThrow:1 GCC_PACK(4);
    BITFIELD bWeaponStay:1;
    BITFIELD bFastActivate:1;
    BITFIELD bIsInventoryWeapon:1;
    ...
    FWAMEntry FireStartAnim;
    FWAMEntry FireStopAnim;
    ...
    BITFIELD bCantSendFire:1 GCC_PACK(4);
    BITFIELD bDontAllowFire:1;
    ...
    BITFIELD bInterruptableReload:1;
...
struct AAmmo_eventGetModeAmmoEvent_Parms
{
    INT ReturnValue;
};
...
public:
    ...
    inline INT __fastcall eventGetModeAmmoEvent()
    {
        AAmmo_eventGetModeAmmoEvent_Parms Parms;
        Parms.ReturnValue=0;
        ProcessEvent(FindFunctionChecked(ENGINE_GetModeAmmoEvent),&Parms);
        return Parms.ReturnValue;
    }
...
{
    class UClass* SpawnClass;
    BITFIELD bTakeParentMountInfo:1 GCC_PACK(4);
};
...
struct ASoftParticleSystem_eventEnabledStateChange_Parms
{
};
...
public:
    ...
    BITFIELD SaveParticles:1 GCC_PACK(4);
    FName SpawnFriendOnDeath GCC_PACK(4);
    ...
    BITFIELD bDontAutoPlayCreationSounds:1 GCC_PACK(4);
    class USound* DestructionSound GCC_PACK(4);
    ...
    FLOAT TurnedOffPitchVariance;
    class USound* TurnedOnSound;
    FLOAT TurnedOnSoundRadius;
    FLOAT TurnedOnPitchVariance;
    class USound* TriggeredSound;
    FLOAT TriggeredSoundRadius;
    BITFIELD bStopSoundsOnDestroy:1 GCC_PACK(4);
    INT SpawnNumber GCC_PACK(4);
    FLOAT SpawnPeriod;
    FLOAT AbsoluteSpawnPeriod;
    INT PrimeCount;
    FLOAT PrimeTime;
...
struct ENGINE_API FSControlPoint
{
    FVector Position;
    class AActor* PositionActor;
};
...
public:
    ...
    FSControlPoint ControlPoint[32] GCC_PACK(4);
...
struct ABreakableGlass_eventGlassRespawned_Parms
{
};
struct ABreakableGlass_eventGlassShattered_Parms
{
};
struct ABreakableGlass_eventGlassCracked_Parms
{
};
class ENGINE_API ABreakableGlass : public ARenderActor
{
public:
    FLOAT GlassSizeX;
    FLOAT GlassSizeY;
    class UTexture* GlassTexture1;
    class UTexture* GlassTexture2;
    class UTexture* GlassTexture3;
    class USound* GlassSound1;
    class USound* GlassSound2;
    class USound* GlassSound3;
    class USound* GlassSound4;
    FLOAT ParticleSize;
    ...
    BITFIELD bGlassTranslucent:1 GCC_PACK(4);
    BITFIELD bGlassModulated:1;
    BITFIELD bGlassMasked:1;
    BITFIELD bTwoSided:1;
    FLOAT BounceScale GCC_PACK(4);
    FLOAT RotateScale;
    FLOAT ParticleLife;
    FLOAT UShift;
    FLOAT VShift;
    ...
    DECLARE_CLASS(ABreakableGlass,ARenderActor,0)
    #include "ABreakableGlass.h"
};
...
AUTOGENERATE_FUNCTION(AActor,-1,execGetSkinList);
...
AUTOGENERATE_FUNCTION(AActor,-1,execCallFunctionByName);
AUTOGENERATE_FUNCTION(AActor,-1,execEndCallbackTimer);
AUTOGENERATE_FUNCTION(AActor,-1,execSetCallbackTimer);
...
AUTOGENERATE_FUNCTION(AActor,-1,execEnumSurfsInRadius);
...
AUTOGENERATE_FUNCTION(APlayerPawn,-1,execSaveLoadActive);
AUTOGENERATE_FUNCTION(APlayerPawn,-1,execDoClientPossess);
...
AUTOGENERATE_FUNCTION(AFocalPoint,499,execNotifyObservers);
...
AUTOGENERATE_FUNCTION(ABreakableGlass,-1,execInternalTick);
AUTOGENERATE_FUNCTION(ABreakableGlass,-1,execGetParticleBox);
AUTOGENERATE_FUNCTION(ABreakableGlass,-1,execBreakGlassXY);
AUTOGENERATE_FUNCTION(ABreakableGlass,-1,execBreakGlassDir);
AUTOGENERATE_FUNCTION(ABreakableGlass,-1,execBreakGlass);
