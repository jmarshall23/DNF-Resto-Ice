...
var()		sound					GaspSound;
var()		sound					PainSounds[16];
var()		sound					MajorPainSounds[16];
var()		sound					Falling_PainSounds[16];
var()		sound					Falling_MajorPainSounds[16];
var()		sound					UnderWaterPain;
var()		sound					DeathSounds[16];
var()		sound					LandGrunt;
var()		sound					SwallowSound;
var()		sound					MirrorSounds[16];
var()		sound					KillSounds[16];
var()		sound					MessyKillSounds[16];
...
// -x
var()		int						NumPickupSounds;
var()		sound					PickupSounds[16];
