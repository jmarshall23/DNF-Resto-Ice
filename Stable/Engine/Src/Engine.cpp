...
// JEP ... (I got global fever)
CORE_API INT	GNumNewObjects					= 0;
CORE_API INT	GNumReplacedObjects				= 0;

CORE_API INT	GNumPreloads					= 0;
CORE_API INT	GNumLazyLoads					= 0;
CORE_API INT	GPreloadSize					= 0;
CORE_API INT	GTexturePreloadSize				= 0;
CORE_API double	GPreloadSerializeTime			= 0;

CORE_API UBOOL	GSaveLoadHack					= false;
// ... JEP
