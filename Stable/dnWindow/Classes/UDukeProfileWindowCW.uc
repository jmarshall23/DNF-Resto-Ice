...
function bool SwitchProfiles()
{
	if (GetPlayerOwner().SwitchToPlayerProfile(PlayerCombo.GetValue()))
	{
		...
		// FairFriend: Profile window is closed and esc button can be used again.
...
function Notify( UWindowDialogControl C, byte E )
{
	...
	// FairFriend: Profile window should have no buttons at all.
	FramedParent.bMessageBoxFrame = true;
