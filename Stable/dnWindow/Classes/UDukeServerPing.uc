//=============================================================================
// UDukeServerPing: Query a server for its details
//=============================================================================
...
function string LocalizeSkin( string SkinName )
{
    ...
    /* FIXME - Use the new GetNextSkin code
...
function AddRule( string Rule, string Value )
{
	...
	for ( RulesList = UDukeRulesList( Server.RulesList.Next ); 
          RulesList != None;
...
Begin:
	...
	{
		Log( "UDukeServerPing: Port failed to bind.  Attempt "$BindAttempts );
		BindAttempts++;
