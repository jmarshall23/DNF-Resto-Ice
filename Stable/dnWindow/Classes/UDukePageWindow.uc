...
function Notify(UWindowDialogControl C, byte E)
{
	...
	if ( ParentWindow != None )
	{
		...
		if ( (FramedParent == None) && (ParentWindow.ParentWindow != None) )
			...
			FramedParent.bExitButtonOnly=false;	// FairFriend: This window should have the reset button.	
	}
...
defaultproperties
{
	ResetText="Reset"
	CloseText="Close"
    bBuildDefaultButtons=false	// FairFriend: This should stay false unless you want
								// ...to ovverride UWindowFramedWindow buttons.
}